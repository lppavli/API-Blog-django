...
class Post(models.Model):
    ...
    read_users = models.ManyToManyField(
        User, through="UserReadPost", verbose_name=_("reads")
    )
...
class UserReadPost(models.Model):
    user = models.ForeignKey(
        User, related_name="user_read_posts", on_delete=models.CASCADE
    )
    post = models.ForeignKey(
        Post, related_name="posts_read_by_users", on_delete=models.CASCADE
    )
